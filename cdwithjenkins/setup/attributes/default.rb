...
default['jenkins']['plugins'] = %w(ghprb chef-identity envinject ansicolor job-dsl)
default['jenkins']['admin']['username'] = 'admin'
default['jenkins']['admin']['password'] = 'CDWorkshop'

default['jenkins']['admin']['private_key'] = %q(-----BEGIN RSA PRIVATE KEY-----
...
default['jenkins']['seedjob']['job-dsl'] = "replace me with some code "
default['jenkins']['seedjob']['name'] = "sample-seed-cookbook-job-dsl"
...
default['jenkins']['chef']['chef_server_url'] = 'https://manage.chef.io/organizations/' + node['jenkins']['chef']['org_name']
